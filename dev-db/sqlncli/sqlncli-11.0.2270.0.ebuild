...
SRC_URI="http://download.microsoft.com/download/B/C/D/BCDD264C-7517-4B7D-8159-C99FC5535680/RedHat6/msodbcsql-11.0.2270.0.tar.gz"
...
src_install() {
	...
	sed -i -e "s,${D},/," "${D}opt/microsoft/sqlncli/11.0.2270.0/sqlncli.ini"
...
pkg_postinst() {
	odbcinst -i -d -f /opt/microsoft/sqlncli/11.0.2270.0/sqlncli.ini
}
